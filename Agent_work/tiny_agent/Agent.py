...
from tiny_agent.LLM import ChatGLM3Chat
from tiny_agent.tool import Tools
...
class Agent:
    ...
    def call_plugin(self, plugin_name, plugin_args):
        ...
        if plugin_name == 'google_search':
            ...
            return '\nObservation:' + self.tool.calculator(**plugin_args)
